...
<body>
  ...
  <div id="main-body">
        ...
        <div class="cards-news">
          <div class="news-1">
            <div class="news-img-container">
              ...
              <a class="news-img" href="">
                <img src="img/how-can-i-66LR.jpg" alt="Netmatters Ltd">
              </a>
            </div>
            <div class="news-text">
              <a href="#" target="_blank">
                <h3>
                  How can I ensure a smooth transition if I swi...
                </h3>
              </a>
              <p>As with any contract for services, it is important that you are regularly reviewing your IT support...
              </p>
              <a href="#">
                <div class="btn news-button"> Read More</div>
              </a>
              <div class="news-poster">
                <div class="news-logo">
                  <img src="img/netmatters-ltd-VXAv.png" alt="Netmatters">
                </div>
                <div class="news-details">
                  <strong class="main-text">Posted by Netmatters Ltd</strong>
                  <br>
                  18th June 2021
                </div>
              </div>
          ...
          <div class="news-2">
            <div class="news-img-container">
              <a href="#" class="category">NEWS</a>
              <a class="news-img" href="">
                <img src="img/happy-25th-birthday-Hn2f.jpg" alt="Birthday">
              </a>
            </div>
            <div class="news-text">
              <a href="#" target="_blank">
                <h3>
                  Happy 25th Birthday Gabriel!
                </h3>
              </a>
              <p>This week, we celebrate Gabriel Hamilton's 25th Birthday! Gabriel is one of the IT technicians based...
              </p>
              <a href="#">
                <div class="btn news-button"> Read More</div>
              </a>
          ...
          <div class="news-3">
            <div class="news-img-container">
              <a href="#" class="category">NEWS</a>
              <a class="news-img" href="">
                <img src="img/may-2021-notables-B8cl.jpg" alt="Netmatters Ltd">
              </a>
            </div>
            <div class="news-text">
              <a href="#" target="_blank">
              ...
              <p>Every month we celebrate the most notable of employees here at Netmatters. Each department head is a...
              </p>
              <a href="#">
                <div class="btn news-button"> Read More</div>
              </a>
    ...
    <section id="newsletter-section">
      <div class="newsletter-main margin-width">
        <form method="POST" action="#" class="sign-up">
          <h2>Email Newsletter Sign-Up</h2>
          <div class="newsletter-input-box">
            <div class="newsletter-input">
              <div class="form-box newsletter-box">
                <label for="newsletter-name" class="required">Your Name</label>
                <input class="input-field" id="newsletter-name" name="name" type="text" required autocomplete="off">
              </div>
            </div>
            <div class="newsletter-input">
              <div class="form-box newsletter-box">
                <label for="newsletter-email" class="required">Your Email</label>
                <input class="input-field" id="newsletter-email" name="email" type="text" required>
              </div>
            </div>
          </div>
          <div class="form-box marketing-box">
    ...
    <footer>
      <div class="footer-inner">
        <div class="footer-content margin-width">
          ...
          <div class="footer-column-4">
            ...
            <div class="social-media">
              <div class="social-btns">
                <div class="social fb-btn">
                  <a href="#">
                    <i class="fab fa-facebook-f" aria-hidden="true"></i>
                  </a>
                </div>
                <div class="social tw-btn">
                  <a href="#">
                    <i class="fab fa-twitter" aria-hidden="true"></i>
                  </a>
                </div>
                <div class="social insta-btn">
                  <a href="#">
                    <i class="fab fa-instagram" aria-hidden="true"></i>
                  </a>
                </div>
                <div class="social li-btn">
                  <a href="#">
    ...
    <!-- Awards -->
    <section class="award-container margin-width">
      <div class="award-box margin-width">
        <div class="award-row-1">
          <div class="award-icon">
            <a href="#">
              <img src="img/b60CSCJ.png" alt="Google Partner">
            </a>
          </div>
          <div class="award-icon">
            <img src="img//silver-microsoft-partner.jpg" alt="Silver Mircrosoft Partner">
          </div>
          <div class="award-icon">
            <img src="img/future-50.jpg" alt="Future 50" class="coloured">
            <img src="img/future-50-bw.jpg" alt="Future 50" class="grey">
          </div>
          <div class="award-icon">
            <img src="img/qms.jpg" alt="QMS ISO 27001" class="coloured">
            <img src="img/qms-bw.jpg" alt="QMS ISO 27001" class="grey">
          </div>
          <div class="award-icon">
            <img src="img/norfolk-carbon-charter.jpg" alt="Norfolk Carbon Charter" class="coloured">
            <img src="img/norfolk-carbon-charter-bw.jpg" alt="Norfolk Carbon Charter" class="grey">
          </div>
        </div>
        <div class="award-row-2">
          <div class="award-icon">
            <img src="img/investing-in-future-growth.jpg" alt="Investing in future growth winner" class="coloured">
            <img src="img/investing-in-future-growth-bw.jpg" alt="Investing in future growth winner" class="grey">
          </div>
          <div class="award-icon">
            <img src="img/princess-royal-training.jpg" alt="Princess Royal Training" class="coloured">
            <img src="img/princess-royal-training-bw.jpg" alt="Princess Royal Training" class="grey">
          </div>
          <div class="award-icon">
            <img src="img/skills-of-tomorrow.jpg" alt="Skills of Tomorrow Winner" class="coloured">
            <img src="img/skills-of-tomorrow-bw.jpg" alt="Skills of Tomorrow Winner" class="grey">
          </div>
          <div class="award-icon">
            <img src="img/PPC_logo.jpg" alt="Prompt Payment Code" class="coloured">
            <img src="img/PPC_logo-bw.jpg" alt="Prompt Payment Code" class="grey">
          </div>
    ...
    <div id="sticky">
        ...
        <div id="container-header2" class="margin-width">
            ...
            <div class="header-buttons">
              ...
              <div class="searchbar">
                <form method="GET" action="#" class="main-search-form">
                  <input type="text" class="main-search-box" placeholder="Search..." id="input-search2"
                    name="site-search">
                  <button type="submit" id="submit-search2">
                    <i class="fas fa-search" aria-hidden="true"></i>
                  </button>
                </form>
              </div>
              <div class="phone-box">
                <a class="call" href="tel:01603704020">
                  <span class="fas fa-phone" aria-hidden="true"></span>
                </a>
              </div>
              <div id="burger-menu2" class="menu">
                <button type="button" id="burger-anim2" class="hamburger hamburger--spin burger-btn">
          ...
          <div class="small-search-box">
            <form>
              ...
              <button class="small-search-submit" type="submit">
                <i class="fas fa-search" aria-hidden="true"></i>
              </button>
            </form>
          </div>
      ...
      <div class="main-navigation">
        <div class="nav-box margin-width">
          <ul class="inner-nav">
            <li class="navweb">
              <a href="#">
  ...
  <div id="sidebar">
    ...
    <div class="sec-sidebar-nav">
      <ul>
        <li>
          <a href="#" class="submenu-heading">Training</a>
          <ul>
        ...
        <li>
          <a href="#" class="submenu-heading">Events</a>
          <ul>
            <li class="second-menu-item">
        ...
        <li>
          <a href="#" class="submenu-heading">Our Company</a>
          <ul>
            <li class="second-menu-item">
        ...
        <li>
          <a href="#" class="submenu-heading">Our Work</a>
          <ul>
            <li class="second-menu-item">
        ...
        <li>
          <a href="#" class="submenu-heading">Our Knowledge</a>
          <ul>
            <li class="second-menu-item">
              <a href="#">Guides</a>
            </li>
        ...
        <li>
          <a href="#" class="submenu-heading">Support</a>
        </li>
      </ul>
    </div>
  </div>
  ...
  <script
    src="https://polyfill.io/v3/polyfill.min.js?features=es2015%2Ces2016%2Ces2017%2Ces2018%2Ces2019%2Ces5%2Ces6%2Cwindow.scroll%2CpageYOffset%2Cdefault%2CIntl">
  </script>
  ...
  <script src="js/dist/main.js" type="text/javascript"></script>
